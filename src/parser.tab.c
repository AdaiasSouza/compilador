...
const int YY_parse_CLASS::IDENTIFIER=260;
...
const int YY_parse_CLASS::TIMES=266;
const int YY_parse_CLASS::DIVIDE=267;
...
static const short yyprhs[] = {     0,
     0,     2,     6,     9,    11,    13,    15,    20,    24,    27,
    29,    31,    35,    39,    43
};

static const short yyrhs[] = {    14,
     0,    15,     8,    14,     0,    15,     8,     0,    16,     0,
    17,     0,    18,     0,     3,     5,     7,    19,     0,     5,
     7,    19,     0,     4,     5,     0,     6,     0,     5,     0,
    19,     9,    19,     0,    19,    10,    19,     0,    19,    11,
    19,     0,    19,    12,    19,     0
};
...
static const short yyrline[] = { 0,
    61,    65,    69,    74,    76,    77,    80,    86,    92,    98,
   100,   101,   104,   107,   110
};

static const char * const yytname[] = {   "$","error","$illegal.","VAR","PRINT",
"IDENTIFIER","NUMBER","EQUALS","SEMICOLON","PLUS","MINUS","TIMES","DIVIDE","program",
"statements","statement","declaration","assignment","print","expression",""
};
#endif
...
static const short yypact[] = {     7,
     0,    12,    11,-32768,    13,-32768,-32768,-32768,    15,-32768,
     8,     7,     8,-32768,-32768,    -8,-32768,    -8,     8,     8,
     8,     8,     4,     4,-32768,-32768,    19,    20,-32768
};

static const short yypgoto[] = {-32768,
    14,-32768,-32768,-32768,-32768,   -13
};
...
static const short yytable[] = {    18,
    19,    20,    21,    22,     9,    23,    24,    25,    26,     1,
     2,     3,    14,    15,    21,    22,    10,    11,    28,    29,
    12,    13,     0,     0,     0,    17
};

static const short yycheck[] = {    13,
     9,    10,    11,    12,     5,    19,    20,    21,    22,     3,
     4,     5,     5,     6,    11,    12,     5,     7,     0,     0,
     8,     7,    -1,    -1,    -1,    12
};
...
#line 66 "parser.y"
{
        yyval.nval = create_node("statements", yyvsp[-2].nval, yyvsp[0].nval);
    ;
    break;}
case 3:
#line 69 "parser.y"
...
#line 81 "parser.y"
{
        yyval.nval = create_node("declaration", create_node(yyvsp[-2].sval, yyvsp[0].nval, NULL), NULL);
    ;
    break;}
case 8:
#line 87 "parser.y"
{
        yyval.nval = create_node("assignment", create_node(yyvsp[-2].sval, yyvsp[0].nval, NULL), NULL);
    ;
    break;}
case 9:
#line 93 "parser.y"
{
        yyval.nval = create_node("print", create_node(yyvsp[0].sval, NULL, NULL), NULL);
    ;
    break;}
case 10:
#line 99 "parser.y"
{ yyval.nval = create_node("number", NULL, NULL); ;
    break;}
case 11:
#line 100 "parser.y"
{ yyval.nval = create_node("identifier", NULL, NULL); ;
    break;}
case 12:
#line 101 "parser.y"
{
        yyval.nval = create_node("plus", yyvsp[-2].nval, yyvsp[0].nval);
    ;
    break;}
case 13:
#line 104 "parser.y"
{
        yyval.nval = create_node("minus", yyvsp[-2].nval, yyvsp[0].nval);
    ;
    break;}
case 14:
#line 107 "parser.y"
{
        yyval.nval = create_node("times", yyvsp[-2].nval, yyvsp[0].nval);
    ;
    break;}
case 15:
#line 110 "parser.y"
{
        yyval.nval = create_node("divide", yyvsp[-2].nval, yyvsp[0].nval);
    ;
    break;}
}
